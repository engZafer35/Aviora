...
* #File Name    : BoardConfig_WindowsPC.h
*******************************************************************************/
...
******************************************************************************/
/******************************IFNDEF & DEFINE********************************/
#ifndef __DRIVER_BOARDS_BOARDCONFIG_WINDOWSPC_H__
#define __DRIVER_BOARDS_BOARDCONFIG_WINDOWSPC_H__
/*********************************INCLUDES*************************************/

/************************* GLOBAL VARIBALE REFERENCES *************************/
#define BOARD_NAME            "Z_METER_GW_WIN64_010101"
#define BOARD_VERSION         "V1.0"
#define BOARD_FILE_NAME       "BoardConfig_WindowsPC.h"
#define WORKING_PLATFORM_PC   (202403)
#define _WORKING_PLATFORM     WORKING_PLATFORM_PC
#define _PLATFORM_NAME        "WIN64-GCC"
#define _MCU_BIT_SIZE         (64)
#define MCU_CORE              "WINDOWS-PC"
#define MCU_PART_NUM          "WINDOWS-PC"
#define OS_WINDOWS            (1)
//#define OS_FREERTOS
/******************************MACRO DEFINITIONS*******************************/
...
#define _GSM_PWR_LED(x)                (printf("GSM PWR LED: %d\n",x))
#define _GSM_SCOM_PWR_LED(x)           (printf("GSM SCOM PWR LED: %d\n",x))
///
#define _TOGGLE_POWER_STATUS_LED()     (printf("BOARD PWR LED Toggled\n"))
#define _TOGGLE_JOB_STATUS_LED()       (printf("JOAB Status LED Toggled\n"))
...
//
#define _INPUT_1_PORT
#define _INPUT_SW1_PIN                 1
#define _INPUT_SW2_PIN                 2

#define _GPIO_SW1_INT_CHNL              EN_EXTI0_IRQ
#define _GPIO_SW2_INT_CHNL              EN_EXTI4_IRQ

#define _IS_INPUT_SW1_PIN(x)            (_INPUT_SW1_PIN == x)
#define _IS_INPUT_SW2_PIN(x)            (_INPUT_SW2_PIN == x)
