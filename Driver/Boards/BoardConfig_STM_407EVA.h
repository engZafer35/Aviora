...
* #File Name    : BoardConfig_STM_407EVA.h
*******************************************************************************/
...
#define BOARD_NAME            "AVIORA_STM_407EVA"
#define BOARD_VERSION         "V1.0"
#define BOARD_FILE_NAME       "BoardConfig_STM_407EVA.h"
...
#define _I2C_WRITE(line, deviceAdr, addr, buff, leng)               HAL_OK//HAL_I2C_Mem_Write(&line, (uint16_t)deviceAdr, addr,
                                                                    //                    I2C_MEMADD_SIZE_8BIT, (uint8_t *)buff, leng, 100)

#define _I2C_READ(line, deviceAdr, addr, buff, leng)                HAL_OK//HAL_I2C_Mem_Read(&line, (uint16_t)deviceAdr, addr,
                                                                    //                   I2C_MEMADD_SIZE_8BIT, (uint8_t *)buff, leng, 100)
