...
#include "../../../CycloneTcp/cyclone_tcp/core/bsd_socket.h"
...
int_t bsd_select(int_t nfds, my_fd_set *readfds, my_fd_set *writefds,
...
void selectFdZero(my_fd_set *fds)
{
...
void selectFdSet(my_fd_set *fds, int_t s)
{
   int_t i;
